...
<body>
	...
	<div id="comment_add">
		<table class="comment_table">
			...
			<tr>
				...
				<td class="input"><textarea rows="3" cols="50" id="add_content"></textarea>
				</td>
			</tr>
			<tr>
	...
	<div id="comment_modify">
		...
		<table class="comment_table">
			...
			<tr>
				<td class="title">내용</td>
				<td class="input"><textarea rows="3" cols="50"
						id="modify_content"></textarea></td>
			</tr>
			<tr>
				<td class="btn" colspan="2">
								...
								$(result.data)
										.each(
												function() {
													...
													html += "(" + this.regdate
															+ ")<br>";// 작성날짜
													html += "<button type='button' onclick='modifyComment("
															+ this.num
															+ ")'>댓글변경</button>&nbsp;";//변경버튼
													html += "<button type='button' onclick='removeComment("
															+ this.num
															+ ")'>댓글삭제</button>&nbsp;";//삭제버튼
													html += "</div>";
